...
See the [wiki tab](https://github.com/Macaulay2/Workshop-2025-tulane]) for project descriptions, schedules, guides, etc. You can also use the [projects tab](https://github.com/Macaulay2/Workshop-YYYY-Location/projects) to keep track of remaining tasks in your project.
